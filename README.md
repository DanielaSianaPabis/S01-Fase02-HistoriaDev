# História de Desenvolvimento Colaborativo
...
O repositório está organizado de forma a refletir um fluxo de desenvolvimento colaborativo, contendo:

- **main**: branch principal, contendo a versão estável do projeto.
- **igor-introducao**: branch secundária, responsável pela introdução da história fictícia.
- **juan-desenvolvimento**: branch secundária, responsável pelo desenvolvimento da história fictícia.
- **daniela-conclusao**: branch secundária, responsável pela conclusão da história fictícia.
...
```bash
git clone https://github.com/DanielaSianaPabis/S01-Fase02-HistoriaDev.git
